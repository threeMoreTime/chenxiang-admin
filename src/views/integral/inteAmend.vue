  ...
  <div class="components-container main-cont">
    ...
    <div style="position: relative;">
      <el-row>
        ...
        <el-col :span="6">
          <span>商品积分：</span>
          <el-input style="width:200px;" @keyup.native="proving" class="margin15" placeholder="请输入商品积分" type="number"
            :min="1" :controls="false" v-model="price" autosize></el-input>
          <p style="color: #F56C6C;font-size: 13px;margin-left: 80px;margin-top: 4px;">注:积分等于商品加邮费</p>
        </el-col>
        <el-col :span="6">
          <span>商品销量：</span>
          <el-input style="width:200px;" @keyup.native="proving" class="margin15" placeholder="请输入商品销量" type="number"
            :min="1" :controls="false" v-model="sales" autosize></el-input>
        </el-col>
        <el-col :span="6">
          <span>商品状态：</span>
      ...
      <el-row>
        <el-col :span="6">
          <span>商品参数：</span>
          <el-input style="width:200px;" class="margin15" placeholder="请输入商品参数" v-model="buyReason" autosize></el-input>
        </el-col>
        <el-col :span="6">
          <span>会员积分：</span>
          <el-input style="width:200px;" @keyup.native="proving" class="margin15" placeholder="请输入会员积分" type="number"
            :min="1" :controls="false" v-model="memberPrice" autosize></el-input>
        </el-col>
        <el-col :span="6">
          <span>是否发货：</span>
      ...
      <div style="display: flex;align-items: center;margin: 2% 0;">
        ...
        <div
          ...
          <el-upload class="avatar-uploader" v-model="coverImg"
            action="https://dianqianadmin.xianmaxiong.com/tao/alioss/upload" :show-file-list="false"
      ...
      <div style="display: flex;align-items: center;margin: 2% 0;flex-flow: wrap;">
        ...
        <div>
          <el-upload action="https://dianqianadmin.xianmaxiong.com/tao/alioss/upload" list-type="picture-card"
      ...
      <div style="display: flex;margin-top: 20px;" v-if="valueshow">
        ...
        <div class="property_table">
          ...
          <el-table :data="valueData">
            <el-table-column v-if="detailJson.length == 1 || detailJson.length == 0" prop="value0" width="120">
            </el-table-column>
      ...
      <div v-if="valueshow1">
        ...
        <div class="property_table" style="display: inline-block;">
          <table style="width: 100%;">
            <tr style="display:flex;text-align: left;">
              <th style="width:150px;" v-for="item in headerData2">{{item}}</th>
            </tr>
          </table>
          <el-table :data="sku">
      ...
      <div style="height: 38px;line-height: 38px;margin:20px 0;">
        ...
        <el-radio-group v-model="positage" @change="agreeChange">
          ...
          <!-- <el-radio :label="1">否</el-radio>
				<el-input v-if="priceshow" style="width:200px;margin-left: 10px;" placeholder="请输入邮费" type="number"  v-model="postagePrice" autosize></el-input> -->
        </el-radio-group>
      </div>
    </div>
...
<script>
  ...
  import quillConfig from '../selfShop/quill-config.js'
  export default {
  	name: 'news',
  	components: {
  		quillEditor
    ...
    methods: {
      ...
      proving() {
        ...
        this.sales = this.sales.replace(/[^\.\d]/g, '');
        this.sales = this.sales.replace('.', '');
      },
      // 返回上一级
      prev() {
        this.$router.back()
      ...
      init() {
        ...
        this.$http({
          ...
          this.isJiFenGoods = returnData.isJiFenGoods
      ...
      create() {
        ...
        this.$http({
          url: this.$http.adornUrl2(`/goods/isFormatAttr?coverImg=${this.coverImg}&price=${this.price}&memberPrice=${this.memberPrice}`),
          method: 'post',
          data: this.attr[0]
        }).then(({
          data
