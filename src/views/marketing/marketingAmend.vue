  ...
  <div class="components-container main-cont">
    ...
    <div style="position: relative;"> 
      ...
      <el-row>
        <el-col :span="24" >
          <span>拼团商品名称：</span>
          <el-input style="width: 200px;" class="margin15" placeholder="请输入拼团商品名称" v-model="title" autosize></el-input>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24" >
      ...
      <el-row>
        <el-col :span="24" >
          <span>拼团时效(小时)：</span>
          <el-input style="width: 200px;" class="margin15" placeholder="请输入拼团时效" type="number" :min="0" :controls="false" v-model="hours" autosize></el-input>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24" >
          <span>拼团人数：</span>
          <el-input style="width: 150px;" class="margin15" placeholder="请输入拼团人数" type="number" :min="0" v-model="number" autosize></el-input>
        </el-col>
      </el-row>
    ...
    export default {
        ...
        methods: {
         ...
         // 选择商品
          ...
          guigeclect(id){
            this.$http({
              url: this.$http.adornUrl2('/selfGroup/showSku'),
              method: 'get',
              params: this.$http.adornParams({
                'groupId':id
              })
          ...
          handleUploadSuccess(file,fileList) {
            ...
            artiReleass(){
              ...
              this.$http({
                url: this.$http.adornUrl2('/selfGroup/update'),
                method: 'post',
            ...
            init() {
                ...
                let id = this.$route.query.id
                  this.$http({
                    url: this.$http.adornUrl2('/selfGroup/find'),
                    method: 'get',
                    params: this.$http.adornParams({
                      'id':id
                    })
                    ...
                    this.groupNumber = returnData.groupNumber
