  ...
  <div class="components-container main-cont">
    <div style="position: relative;">
      ...
      <el-row>
        <el-col :span="24" >
          <span>拼团商品名称：</span>
          <el-input style="width: 500px;" class="margin15" placeholder="请输入拼团商品名称" v-model="title" autosize></el-input>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24" >
          <span>拼团商品价格：</span>
          <el-input style="width: 200px;" class="margin15" placeholder="请输入拼团商品价格" v-model="price" autosize></el-input>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24" >
          <span>拼团会员价格：</span>
          <el-input style="width: 200px;" class="margin15" placeholder="请输入拼团会员价格" v-model="memberPrice" autosize></el-input>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24" >
      ...
      <el-row>
        <el-col :span="24" >
          <span>拼团时效(小时)：</span>
          <el-input style="width: 200px;" class="margin15" placeholder="请输入拼团时效" type="number" :min="1" :controls="false" v-model="hours" autosize></el-input>
        </el-col>
      </el-row>
      <el-row style="margin-bottom: 15px;">
        <el-col :span="24" >
          <span>拼团人数：</span>
          <el-input style="width: 150px;" class="margin15" placeholder="请输入拼团人数" type="number" :min="2" v-model="number" autosize></el-input>
        </el-col>
      </el-row>
      <div style="display: flex;margin-top: 20px;" v-if="propshow">
        ...
        <div class="property_table">
          ...
          <el-table
            ...
            <template slot-scope="scope">
              <div>
                <el-input type="number" v-model="scope.row.pinkPrice" :min="0"  style="width:80px;font-size:14px;">
                </el-input>
              </div>
            </template>
            </el-table-column>
            ...
            <template slot-scope="scope">
              <div>
                <el-input type="number" v-model="scope.row.pinkStock" :min="1" :max="scope.row.stock" style="width:80px;font-size:14px;">
                </el-input>
              </div>
            </template>
            </el-table-column>
      ...
      <div style="display: flex;margin-top: 20px;" v-if="propshow1">
        ...
        <div class="property_table">
          <table style="width: 100%;">
            <tr style="display:flex;">
              <th style="width:120px;text-align: left;" v-for="item in headerData2">{{item}}</th>
            </tr>
          </table>
          <el-table
            :data="valueData2">
            ...
            <template slot-scope="scope">
              <div class="imgWrap" style=" width:60px;height:60px;background-color: #fbfdff; border: 1px dashed #c0ccda;border-radius: 6px;text-align: center;line-height: 60px;">
                <el-upload
                  ...
                  >
                  <img v-if="scope.row.skuImg" :src="scope.row.skuImg" class="avatar" style="border-radius: 6px;width:60px;height: 60px;"/>
                  <i v-else class="el-icon-plus avatar-uploader-icon" @click="curRowIndex=scope.$index"></i>
                </el-upload>
              </div>
            </template>
    ...
    export default {
        ...
        methods: {
         ...
         // 选择商品
          ...
          guigeclect(id){
            this.$http({
              url: this.$http.adornUrl2('/selfGroup/onlyFormatSku'),
              method: 'get',
              params: this.$http.adornParams({
                'goodsId':id
              })
          ...
          duoguigeclect(id){
            this.$http({
              url: this.$http.adornUrl2('/selfGroup/isFormatSku'),
              method: 'get',
              params: this.$http.adornParams({
                'goodsId':id
              })
          ...
          prev(){
            ...
            artiReleass(){
              ...
              this.$http({
                url: this.$http.adornUrl2('/selfGroup/save'),
                method: 'post',
