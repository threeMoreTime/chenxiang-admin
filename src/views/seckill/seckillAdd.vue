    ...
    <div style="position: relative;">
      ...
      <div style="display: flex;align-items: center;margin: 2% 0;">
        ...
        <el-radio-group v-model="guige">
            <el-radio :label="0" disabled>单规格</el-radio>
            <el-radio :label="1" disabled>多规格</el-radio>
        </el-radio-group>
      </div>
      ...
      <div style="display: flex;margin-top: 20px;" v-if="propshow1">
        ...
        <div class="property_table">
          ...
          <el-table
            ...
            <template slot-scope="scope">
              <div>
                <el-input type="text" hidden v-model="scope.row.secKillId"  style="width:60px;font-size:14px;">
                </el-input>
              </div>
            </template>
            </el-table-column>
    ...
    export default {
        ...
        methods: {
         ...
         // 选择商品
          ...
          guigeclect(id){
            this.$http({
              url: this.$http.adornUrl2('/selfSecKill/onlyFormatSku'),
              method: 'get',
              params: this.$http.adornParams({
                'goodsId':id
              })
          ...
          duoguigeclect(id){
            this.$http({
              url: this.$http.adornUrl2('/selfSecKill/isFormatSku'),
              method: 'get',
              params: this.$http.adornParams({
                'goodsId':id
              })
          ...
          prev(){
            ...
            artiReleass(){
              ...
              this.$http({
                url: this.$http.adornUrl2('/selfSecKill/save'),
                method: 'post',
