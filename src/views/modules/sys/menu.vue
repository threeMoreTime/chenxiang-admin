<template>
  <div class="mod-menu">
    <el-form :inline="true" :model="dataForm">
      <el-form-item>
        <el-button  type="primary" :disabled="!isAuth('sys:menu:save')"   @click="addOrUpdateHandle()">添加</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl2('/sys/menu/list'),
          method: 'get',
      ...
      deleteHandle (id) {
        this.$confirm(`确定对[id=${id}]进行[删除]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl2(`/sys/menu/delete/${id}`),
            method: 'post',
